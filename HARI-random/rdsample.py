...
from trl_main.data_utils import Dataset
from trl_main.trainer.utils import RepeatSampler, Sampler
...
class GRPOTrainerRandom(GRPOTrainer):
    def _get_train_sampler(self, dataset: Dataset | None = None) -> Sampler:
        if dataset is None:
            dataset = self.train_dataset

        print("Initializing RandomSampler...")
...
trainer.train(resume_from_checkpoint="/home/dangyunkai/yunkai/VLM/VIG-Group/jiarui/HARI_random/HARI-random/checkpoint-12000")
