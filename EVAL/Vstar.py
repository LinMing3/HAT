...
RESULTS_SAVE_DIR = Path(
    os.environ.get(
        "RESULT_SAVE_PATH",
        "/home/yangjiacheng/data/jiarui/HARI-75retry/EVAL-all/Vstar",
    )
)
...
image_root = "/data1/yangjiacheng/vstar_bench"
dataset = datasets.load_dataset(
    "json", 
    data_files="/data1/yangjiacheng/vstar_bench/test_questions.jsonl",
    )
...
summary_path = RESULTS_SAVE_DIR/f"Vstar-checkpoint-{step_part}-{average_accuracy:.2%}.json"
