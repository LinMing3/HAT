...
trained_model_id = os.environ.get(
    "TRAINED_MODEL_ID",
    "/home/dangyunkai/yunkai/VLM/VIG-Group/jiarui/HARI-halfretry-more/HARI-strict-reward/checkpoint-23000",
)
...
MME_JSON_PATH = os.environ.get(
    "MME_JSON_PATH",
    "/data1/yunkai/VIG_Group/dataset/MME-RealWorld-Lite/MME-RealWorld-Lite.json",
)
