...
print("Loading HR-Bench 4K dataset...")
dataset = load_dataset("/data1/yunkai/VIG_Group/dataset/HR-Bench")
test_dataset = dataset["hrbench_4k"]
...
local_image_path = '/data1/yunkai/VIG_Group/dataset/HR-Bench/4k-images'
